 ...
 */
class SomosmaestrosModelArticulos extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__somosmaestros_articulos` AS a');
		...
		$query->select('#__somosmaestros_categorias_articulos_1878022.categoria AS categoriasarticulos_categoria_1878022');
		$query->join('LEFT', '#__somosmaestros_categorias_articulos AS #__somosmaestros_categorias_articulos_1878022 ON #__somosmaestros_categorias_articulos_1878022.id = a.categoria');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.titulo LIKE '.$search.'  OR  a.categoria LIKE '.$search.'  OR  a.destacado LIKE '.$search.'  OR  a.publico LIKE '.$search.'  OR  a.delegacion LIKE '.$search.'  OR  a.tipo_institucion LIKE '.$search.'  OR  a.segmento LIKE '.$search.'  OR  a.nivel LIKE '.$search.'  OR  a.ciudad LIKE '.$search.'  OR  a.area LIKE '.$search.'  OR  a.rol LIKE '.$search.'  OR  a.proyecto LIKE '.$search.' )');
            }
        }
