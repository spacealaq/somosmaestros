 ...
 */
class SomosmaestrosModelBlogs extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__somosmaestros_blogs` AS a');
		...
		$query->select('#__somosmaestros_categorias_blog_1879760.categoria AS categoriasblog_categoria_1879760');
		$query->join('LEFT', '#__somosmaestros_categorias_blog AS #__somosmaestros_categorias_blog_1879760 ON #__somosmaestros_categorias_blog_1879760.id = a.categoria');
