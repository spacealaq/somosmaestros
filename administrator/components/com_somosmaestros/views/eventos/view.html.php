 ...
 */
class SomosmaestrosViewEventos extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        SomosmaestrosHelper::addSubmenu('eventos');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SOMOSMAESTROS_TITLE_EVENTOS'), 'eventos.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_somosmaestros&view=eventos');
