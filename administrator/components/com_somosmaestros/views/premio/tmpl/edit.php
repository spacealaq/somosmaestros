...
<script type="text/javascript">
    ...
    {
        if (task == 'premio.cancel') {
            Joomla.submitform(task, document.getElementById('premio-form'));
        }
        else {
            
            if (task != 'premio.cancel' && document.formvalidator.isValid(document.id('premio-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_somosmaestros&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="premio-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SOMOSMAESTROS_TITLE_PREMIO', true)); ?>
        <div class="row-fluid">
            <div class="span10 form-horizontal">
				...
				<div class="control-label"><?php echo $this->form->getLabel('premio'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('premio'); ?></div>
			</div>
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('cantidad'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('cantidad'); ?></div>
			</div>
			<div class="control-group">
