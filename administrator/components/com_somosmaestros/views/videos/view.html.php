 ...
 */
class SomosmaestrosViewVideos extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        SomosmaestrosHelper::addSubmenu('videos');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SOMOSMAESTROS_TITLE_VIDEOS'), 'videos.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_somosmaestros&view=videos');
	...
	protected function getSortFields()
	{
		...
		'a.url' => JText::_('COM_SOMOSMAESTROS_VIDEOS_URL'),
		'a.titulo' => JText::_('COM_SOMOSMAESTROS_VIDEOS_TITULO'),
		);
	}
