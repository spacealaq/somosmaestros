...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_somosmaestros&task=logs.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="logList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_somosmaestros&task=log.edit&id='.(int) $item->id); ?>">
