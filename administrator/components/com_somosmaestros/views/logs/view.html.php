 ...
 */
class SomosmaestrosViewLogs extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        SomosmaestrosHelper::addSubmenu('logs');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SOMOSMAESTROS_TITLE_LOGS'), 'logs.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_somosmaestros&view=logs');
	...
	protected function getSortFields()
	{
		...
		'a.date' => JText::_('COM_SOMOSMAESTROS_LOGS_DATE'),
		'a.time' => JText::_('COM_SOMOSMAESTROS_LOGS_TIME'),
		'a.vista' => JText::_('COM_SOMOSMAESTROS_LOGS_VISTA'),
		'a.cedula' => JText::_('COM_SOMOSMAESTROS_LOGS_CEDULA'),
		);
	}
