 ...
 */
class SomosmaestrosViewBlogs extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        SomosmaestrosHelper::addSubmenu('blogs');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SOMOSMAESTROS_TITLE_BLOGS'), 'blogs.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_somosmaestros&view=blogs');
        ...
        $form = JForm::getInstance('com_somosmaestros.blog', 'blog');
	...
	protected function getSortFields()
	{
		...
		'a.titulo' => JText::_('COM_SOMOSMAESTROS_BLOGS_TITULO'),
		'a.categoria' => JText::_('COM_SOMOSMAESTROS_BLOGS_CATEGORIA'),
		'a.destacado' => JText::_('COM_SOMOSMAESTROS_BLOGS_DESTACADO'),
		'a.publico' => JText::_('COM_SOMOSMAESTROS_BLOGS_PUBLICO'),
		'a.delegacion' => JText::_('COM_SOMOSMAESTROS_BLOGS_DELEGACION'),
		'a.tipo_institucion' => JText::_('COM_SOMOSMAESTROS_BLOGS_TIPO_INSTITUCION'),
		'a.segmento' => JText::_('COM_SOMOSMAESTROS_BLOGS_SEGMENTO'),
		'a.nivel' => JText::_('COM_SOMOSMAESTROS_BLOGS_NIVEL'),
		'a.ciudad' => JText::_('COM_SOMOSMAESTROS_BLOGS_CIUDAD'),
		'a.area' => JText::_('COM_SOMOSMAESTROS_BLOGS_AREA'),
		'a.rol' => JText::_('COM_SOMOSMAESTROS_BLOGS_ROL'),
		'a.proyecto' => JText::_('COM_SOMOSMAESTROS_BLOGS_PROYECTO'),
		);
	}
