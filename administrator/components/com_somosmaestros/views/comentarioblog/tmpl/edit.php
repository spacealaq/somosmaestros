...
<script type="text/javascript">
    ...
    {
        if (task == 'comentarioblog.cancel') {
            Joomla.submitform(task, document.getElementById('comentarioblog-form'));
        }
        else {
            
            if (task != 'comentarioblog.cancel' && document.formvalidator.isValid(document.id('comentarioblog-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_somosmaestros&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="comentarioblog-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SOMOSMAESTROS_TITLE_COMENTARIOBLOG', true)); ?>
        <div class="row-fluid">
