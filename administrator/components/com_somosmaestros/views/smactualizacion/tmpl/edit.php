...
<script type="text/javascript">
    ...
    {
        if (task == 'smactualizacion.cancel') {
            Joomla.submitform(task, document.getElementById('smactualizacion-form'));
        }
        else {
            
            if (task != 'smactualizacion.cancel' && document.formvalidator.isValid(document.id('smactualizacion-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_somosmaestros&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="smactualizacion-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SOMOSMAESTROS_TITLE_SMACTUALIZACION', true)); ?>
        <div class="row-fluid">
