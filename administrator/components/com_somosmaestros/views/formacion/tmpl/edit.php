...
<script type="text/javascript">
    ...
    {
        if (task == 'formacion.cancel') {
            Joomla.submitform(task, document.getElementById('formacion-form'));
        }
        else {
            
            if (task != 'formacion.cancel' && document.formvalidator.isValid(document.id('formacion-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_somosmaestros&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="formacion-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SOMOSMAESTROS_TITLE_FORMACION', true)); ?>
        <div class="row-fluid">
