						...
						<div class="span10">
							<form id="formCrearBlog" class="row form-crear">
								...
								<div class="span10">
									...
									<input name="tituloBlog" id="tituloBlog" type="text">
								</div>		
								<div class="span5">
								...
								<div class="span10">
									...
									<textarea name="previewBlog" id="previewBlog"></textarea>
								</div>			
								<div class="span5">
									<label for="fuenteBlog">Fuente:</label>
									<input name="fuenteBlog" id="fuenteBlog" type="text">
								</div>					
								<div class="span10">
								...
								<div id="segmentacion">
									...
									<div class="span5">
										<label for="segmentoBlog">Segmento: </label>
									...
									<div class="span5">
										<label for="nivelBlog">Nivel:</label>
									...
									<div class="span5">
										<label for="ciudadBlog">Ciudad:</label>
									...
									<div class="span5">
										<label for="proyectoBlog">Proyecto</label>
								...
								<div class="span5"></div>
								<div class="span10">
									<div id="btn_crearBlog" class="btn btn-primary btn-publicar">
										<i class="fa fa-bookmark fa fa-white"></i> Crear Blog
									</div>
								</div>
							</form>
						</div>
...
jQuery(document).ready(function(){
	...
	jQuery("#btn_crearBlog").click(function(){	
		jQuery.ajax({
			type: "POST",
			url: "index.php?option=com_functions&task=crearBlog",
			data: { 
			...
			success: function( response ) {
				if( response ){
					alert("Tu blog se ha creado correctamente");
