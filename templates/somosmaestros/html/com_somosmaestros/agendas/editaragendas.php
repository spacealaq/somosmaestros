...
$parametrosAgd = $modeloAgendas->getItems();
						...
						<div class="span10">
							<form id="formCrearAgenda" class="row form-crear">
								...
								<div class="span5">
									...
									<input name="tituloAgenda" id="tituloAgenda" type="text" value="<?php echo $p->titulo ?>">
								</div>	
								<!--<div class="span5">
									<label for="disponibilidadAgendas">Disponibilidad:</label>
									<input name="disponibilidadAgendas" id="disponibilidadAgendas" type="text" value="<?php echo $p->disponibilidad ?>">
								</div>	-->				
								<div class="span5">
								...
								<div class="span5">
									...
									<input name="fuenteAgenda" id="fuenteAgenda" type="text" value="<?php echo $p->fuente; ?>">
								</div>	
								<div class="span5">
								...
								<div class="span10">
									...
									<textarea name="previewAgenda" id="previewAgenda"><?php echo $p->preview; ?></textarea>
								</div>							
								<div class="span10">
								...
								<div id="segmentacion">
									...
									<div class="span5">
										<label for="segmentoAgenda">Segmentos: </label>
										<?php echo $p->segmento ?>
									...
									<div class="span5">
										<label for="nivelAgenda">Niveles:</label>
										<?php echo $p->nivel ?>
									...
									<div class="span5">
										<label for="ciudadAgenda">Ciudades:</label>
										<?php echo $p->ciudad ?>
									...
									<div class="span5">
										<label for="areaAgenda">Áreas:</label>
										<?php echo $p->area ?>
									...
									<div class="span5">
										<label for="proyectoAgenda">Proyectos:</label>
										<?php echo $p->proyecto ?>
								...
								<div class="span5"></div>
								<div class="span10">
					  					<div id="btn_guardarAgenda" class="btn btn-primary">
											<i class="icon-bookmark icon-white"></i> Guardar Agenda
										</div>
								</div>
							</form>
						</div>
...
jQuery(document).ready(function(){
	...
	jQuery("#btn_guardarAgenda").click(function(){
					jQuery.ajax({
						type: "POST",
						url: "index.php?option=com_functions&task=guardarAgenda",
						data: { 
							id: <?php echo $idAgenda; ?>,
						...
						success: function( response ) {
							if( response ){
								alert("Tu Agenda Cultural se ha modificado correctamente");
