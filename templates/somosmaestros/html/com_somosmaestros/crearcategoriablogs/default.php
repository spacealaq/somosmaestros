						...
						<div class="span10">
							<form id="formCrearCategoria" class="row form-crear">
								<div class="span10">
									...
									<input name="categoriaBlog" id="categoriaBlog" type="text">
								</div>	
								<div class="span10">
									<label for="descripcionBlog">Descripción:</label>
									<input name="descripcionBlog" id="descripcionBlog" type="text">
								</div>	
								<div class="span5">
...
<script type="text/javascript">
	...
	var uploadObj2 = jQuery("#multiplefileuploader2").uploadFile(settings2);
		...
		jQuery("#btn_categoriaBlog").click(function(){
				jQuery.ajax({
				type: "GET",
				url: "index.php?option=com_functions&task=crearCategoriaBlog",
				data: { 
