...
$result = JFactory::getDbo()->insertObject('#__somosmaestros_sm_brujula', $usuario);
/*
	...
	<div class="span10 offset1">
		...
		<div class="cajaGris">
			<?php if($result){ ?>
				...
				<a href="index.php?option=com_somosmaestros&view=funcionarios&Itemid=2177" class="btn">Volver</a>
			<?php }else{ ?>
