<?php 
 ...
 $dia = date('d/m/Y');
 header("Content-Disposition:  filename=\"Usuarios - Fecha: ".$dia.".XLS\";");
...
if($tipo == 'PR'){
	...
	<table border='1'>
	   ...
	   <tr>
	    ...
	    <td align='center' style='font-size:14px'><strong>Cédula</strong></td>
