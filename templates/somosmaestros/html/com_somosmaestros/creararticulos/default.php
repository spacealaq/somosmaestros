						...
						<div class="span10">
							<form id="formCrearArticulo" class="row form-crear">
								...
								<div class="span10">
									...
									<input name="tituloArticulo" id="tituloArticulo" type="text">
								</div>		
								<div class="span5">
								...
								<div class="span10">
									...
									<textarea name="previewArticulo" id="previewArticulo"></textarea>
								</div>			
								<div class="span5">
									<label for="fuenteArticulo">Fuente:</label>
									<input name="fuenteArticulo" id="fuenteArticulo" type="text">
								</div>			
								<div class="span10">
								...
								<div id="segmentacion">
									...
									<div class="span5">
										<label for="segmentoArticulo">Segmento: </label>
									...
									<div class="span5">
										<label for="nivelArticulo">Nivel:</label>
									...
									<div class="span5">
										<label for="ciudadArticulo">Ciudad:</label>
									...
									<div class="span5">
										<label for="areaArticulo">Área</label>
									...
									<div class="span5">
										<label for="proyectoArticulo">Proyecto</label>
								...
								<div class="span5"></div>
								<div class="span10">
									<div id="btn_crearArticulo" class="btn btn-primary btn-publicar">
										<i class="icon-bookmark icon-white"></i> Crear Artículo
									</div>
								</div>
							</form>
						</div>
...
jQuery(document).ready(function(){
	...
	jQuery("#btn_crearArticulo").click(function(){			
		jQuery.ajax({
			type: "POST",
			url: "index.php?option=com_functions&task=crearArticulo",
			data: { 
			...
			success: function( response ) {
				if( response ){
					alert("Tu artículo se ha creado correctamente");
