...
if($user->get('id') ){ 
	...
	$usuarios = $modeloUsuarios->getItems();
						...
						<div class="span10">
							<form id="formCrearCategoria" class="row form-crear">
								<div class="span5">
									...
									<input name="nombreUsuario" id="nombreUsuario" type="text" value="<?php echo $usuario->nombre ?>">
								</div>
								<div class="span5">
									<label for="cedulaUsuario">Cédula:</label>
									<input name="cedulaUsuario" id="cedulaUsuario" type="text" value="<?php echo $usuario->usuario ?>">
								</div>	
								<div class="span5">
									<label for="contraseñaUsuario">Contraseña: (igual al documento de identidad)</label>
									<input name="contraseñaUsuario" id="contraseñaUsuario" type="text" value="<?php echo $usuario->password ?>">
								</div>	
								<div class="span5">
								...
								<div class="span10">
									<div id="btn_usuarios" class="btn btn-primary">
										<i class="icon-bookmark icon-white"></i> Guardar Usuario
									</div>
								</div>
							</form>
						</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		jQuery("#btn_usuarios").click(function(){
				jQuery.ajax({
				type: "GET",
				url: "index.php?option=com_functions&task=guardarUsuarioSM",
				data: { 
