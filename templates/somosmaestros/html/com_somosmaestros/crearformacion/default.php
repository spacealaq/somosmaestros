						...
						<div class="span10">
							<form id="formCrearFormacion" class="row form-crear">
								...
								<div class="span5">
									...
									<input name="tituloFormacion" id="tituloFormacion" type="text">
								</div>	
								<div class="span5">
									<label for="disponibilidadFormacion">Disponibilidad:</label>
									<input name="disponibilidadFormacion" id="disponibilidadFormacion" type="text">
								</div>	
								<div class="span5">
									<label for="fuenteFormacion">Fuente:</label>
									<input name="fuenteFormacion" id="fuenteFormacion" type="text">
								</div>	
								<div class="span5">
								...
								<div class="span10">
									...
									<textarea name="previewFormacion" id="previewFormacion"></textarea>
								</div>		
								<div class="span5"></div>					
								<div class="span10">
								...
								<div class="span5">
									...
									<img id="imagenFormacion2" class="imagenPequeña">
								...
								<div id="segmentacion">
									...
									<div class="span5">
										<label for="segmentoFormacion">Segmento: </label>
									...
									<div class="span5">
										<label for="nivelFormacion">Nivel:</label>
									...
									<div class="span5">
										<label for="areaFormacion">Área</label>
									...
									<div class="span5">
										<label for="proyectoFormacion">Proyecto</label>
								...
								<div class="span5"></div>
								<div class="span10">
									<div id="btn_crearFormacion" class="btn btn-primary btn-publicar">
										<i class="icon-bookmark icon-white"></i> Crear Formación
									</div>
								</div>
							</form>
						</div>
...
jQuery(document).ready(function(){
	...
	jQuery("#btn_crearFormacion").click(function(){			
		jQuery.ajax({
			type: "POST",
			url: "index.php?option=com_functions&task=crearFormacion",
			data: { 
			...
			success: function( response ) {
				if( response ){
					alert("Tu formación se ha creado correctamente");
