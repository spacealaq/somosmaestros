...
<script type="text/javascript">
    if (jQuery === 'undefined') {
        document.addEventListener("DOMContentLoaded", function(event) { 
            jQuery('#form-smpersona').submit(function(event) {
...
<div class="smpersona-edit front-end-edit">
    ...
    <form id="form-smpersona" action="<?php echo JRoute::_('index.php?option=com_somosmaestros&task=smpersona.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<div class="control-group">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_somosmaestros&task=smpersonaform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
        
        <input type="hidden" name="option" value="com_somosmaestros" />
        <input type="hidden" name="task" value="smpersonaform.save" />
