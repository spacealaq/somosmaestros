...
<script type="text/javascript">
    if (jQuery === 'undefined') {
        document.addEventListener("DOMContentLoaded", function(event) { 
            jQuery('#form-formacion').submit(function(event) {
...
<div class="formacion-edit front-end-edit">
    ...
    <form id="form-formacion" action="<?php echo JRoute::_('index.php?option=com_somosmaestros&task=formacion.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<div class="control-group">
		<div class="control-label"><?php echo $this->form->getLabel('asistentes'); ?></div>
		<div class="controls"><?php echo $this->form->getInput('asistentes'); ?></div>
	</div>
	<div class="control-group">
		<div class="control-label"><?php echo $this->form->getLabel('disponibilidad'); ?></div>
		<div class="controls"><?php echo $this->form->getInput('disponibilidad'); ?></div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_somosmaestros&task=formacionform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
        
        <input type="hidden" name="option" value="com_somosmaestros" />
        <input type="hidden" name="task" value="formacionform.save" />
