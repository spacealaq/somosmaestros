 ...
 */
class SomosmaestrosModelCategoriasblog extends JModelList
{
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__somosmaestros_categorias_blog` AS a');
	...
	$query->where('a.state = 1');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.categoria LIKE '.$search.'  OR  a.descripcion LIKE '.$search.' )');
			}
		}
