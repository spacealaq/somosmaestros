		...
		foreach($items as $item){
			...
			if (isset($item->categoria) && $item->categoria != '') {
				if(is_object($item->categoria)){
					$item->categoria = JArrayHelper::fromObject($item->categoria);
				}
				$values = (is_array($item->categoria)) ? $item->categoria : explode(',',$item->categoria);
			...
			$item->categoria = !empty($textValue) ? implode(', ', $textValue) : $item->categoria;
