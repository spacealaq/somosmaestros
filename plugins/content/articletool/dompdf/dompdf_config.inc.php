...
__autoload("canvas");
__autoload("cpdf_adapter");
__autoload("pdflib_adapter");
__autoload("canvas_factory");
__autoload("abstract_renderer");
__autoload("block_renderer");
__autoload("text_renderer");
__autoload("inline_renderer");
__autoload("image_renderer");
__autoload("list_bullet_renderer");
__autoload("table_cell_renderer");
__autoload("renderer");
__autoload("image_cache");
__autoload("dompdf");
__autoload("frame_tree");
__autoload("stylesheet");
__autoload("frame");
__autoload("font_metrics");
__autoload("style");
__autoload("attribute_translator");
__autoload("frame_reflower");
__autoload("page_frame_reflower");
__autoload("block_frame_reflower");
__autoload("frame_decorator");
__autoload("text_frame_decorator");
__autoload("positioner");
__autoload("inline_positioner");
__autoload("text_frame_reflower");
__autoload("inline_frame_decorator");
__autoload("image_frame_reflower");
__autoload("image_frame_decorator");
__autoload("inline_frame_reflower");
__autoload("list_bullet_image_frame_decorator");
__autoload("list_bullet_positioner");
__autoload("list_bullet_frame_decorator");
__autoload("list_bullet_frame_reflower");
__autoload("null_frame_reflower");
__autoload("null_positioner");
__autoload("null_frame_decorator");
__autoload("cellmap");
__autoload("table_frame_decorator");
__autoload("table_frame_reflower");
__autoload("table_row_positioner");
__autoload("table_row_group_frame_decorator");
__autoload("table_row_group_frame_reflower");
__autoload("table_row_frame_decorator");
__autoload("table_row_frame_reflower");
__autoload("block_frame_decorator");
__autoload("table_cell_frame_decorator");
__autoload("table_cell_positioner");
__autoload("table_cell_frame_reflower");
__autoload("frame_factory");
__autoload("frame_decorator");
__autoload("page_frame_decorator");
__autoload("positioner");
__autoload("block_positioner");
